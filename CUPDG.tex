...
\begin{titlepage}
    ...
    \vspace{39pt}
    \fontsize{22}{26.4}\selectfont{\haettenfont v5. 0. 3\normalfont }\par % 版本
    \vspace{52.8pt}
    \fontsize{18}{21.6}\selectfont{作者：刈夫和石大的同学们}\par % 作者
    \fontsize{18}{21.6}\selectfont{最后编辑时间：2025年3月17日}\par % 最后编辑时间
    \vfill
\end{titlepage}
...
\textbf{\subsubsection*{5. 醉面（提供者：GF）}}
\addcontentsline{toc}{subsubsection}{3.1.6 \ 醉面}
不必多说，每次一到饭点人都爆满。个人非常喜欢炸鸡排，五块多一份。他家的红烧牛肉面，吃面首选。但是小程序杀熟，吃得多了就不给派券了。悦荟也有一家，怎么方便怎么来。

\textbf{\subsubsection*{6. 爆香鸡（提供者：GF）}}
\addcontentsline{toc}{subsubsection}{3.1.7 \ 爆香鸡}
...
\textbf{\subsubsection*{7. 老郑脆皮冰茶烤鸭（提供者：GF）}}
\addcontentsline{toc}{subsubsection}{3.1.8 \ 老郑脆皮冰茶烤鸭}
曾经被名字吸引过，去吃了一次，想报警。室友在这家吃出过虫子，慎点。

\textbf{\subsubsection*{8. 满巍明生炸鸡架（提供者：GF）}}
\addcontentsline{toc}{subsubsection}{3.1.9 \ 满巍明生炸鸡架}
很香，经常在放学路上被它馋得走不动道。但是也真的很贵，导致我到现在就买过一次。

\textbf{\subsubsection*{9. 江西瓦罐（提供者：GF）}}
\addcontentsline{toc}{subsubsection}{3.1.10 \ 江西瓦罐}
...
（GF补充：虾吃虾涮在某音买团购后去吃。吃完虾锅还可以免费无线续面，特别好吃。）
...
\textbf{\subsubsection*{8. 煲仔皇（提供者：GF）}}
\addcontentsline{toc}{subsubsection}{3.6.8 \ 煲仔皇}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.75\textwidth]{pics/校外/更远/车轮饼.png}
\end{figure}
车轮饼真的很好吃！

\textbf{\subsubsection*{13. 麦香炸鸡（提供者：GF）}}
\addcontentsline{toc}{subsubsection}{3.8.13 \ 麦香炸鸡}
坐标昌平地铁站A口对面，我愿称之为昌平最好吃的炸鸡。小时候的味道。
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.75\textwidth]{pics/校外/更远/麦香炸鸡.png}
\end{figure}

\textbf{\subsubsection*{14. 巴依老爷新疆美食（提供者：GF）}}
\addcontentsline{toc}{subsubsection}{3.8.14 \ 巴依老爷新疆美食}
吃过一次，价格很贵，建议像我这样没钱的朋友们不要轻易尝试。味道仁者见仁，个人觉得还行，羊肉串好吃，但是不爱吃的朋友也有很多。

\textbf{\subsubsection*{15. 思念妈妈东北菜馆（提供者：Aurora）}}
\addcontentsline{toc}{subsubsection}{3.8.15 \ 思念妈妈东北菜馆}
和周边同学去了好几次了,个人推荐晾衣大饼(口感类似蛋挞皮),铁板烧烤,小炒黄牛肉和锅包肉！
\newpage
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.75\textwidth]{pics/校外/更远/思念妈妈东北菜馆.png}
\end{figure}
