...
\textbf{\subsubsection*{6. 醉面（提供者：GF）}}
...
\textbf{\subsubsection*{7. 爆香鸡（提供者：GF）}}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.65\textwidth]{pics/校外/更远/麦香炸鸡.png}
\end{figure}
